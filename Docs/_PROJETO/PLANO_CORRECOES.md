...
- **Pendente (Sprint 23+):** rotas `/:id/notes` e `/:id/baixa` do patrimônio ainda em express-validator (campos simples). Frontend pages com schemas locais redundantes (TipoBemManagement, AcquisitionFormManagement).
