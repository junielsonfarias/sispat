...
`
  ...
  console.log('⚠️  IMPORTANTE: Configure as variáveis de ambiente no arquivo .env antes de continuar')
...
try {
  ...
  console.log('   Por favor, instale o PostgreSQL e certifique-se de que está rodando')
...
console.log('1. Configure o arquivo .env com suas configurações do banco de dados')
