...
# =================================
# CORREÇÃO ERRO VITE CONFIG - SISPAT
# Script para corrigir erro "baseUrl is not defined" no vite.config.ts
# =================================
...
echo ""
echo "🔧 ================================================"
echo "🔧    CORREÇÃO ERRO VITE CONFIG - SISPAT"
echo "🔧    Solução para erro 'baseUrl is not defined'"
echo "🔧 ================================================"
echo ""
...
log "🔧 Iniciando correção do erro vite.config.ts..."
...
# 3. Criar configuração Vite corrigida
log "🔧 Criando configuração Vite corrigida..."
...
EOF
success "Configuração Vite corrigida criada"
...
# 6. Fazer build com configuração corrigida
log "🏗️ Fazendo build com configuração corrigida..."
...
if [ -d "dist" ] && [ -f "dist/index.html" ]; then
    ...
    if ls dist/assets/vendor-react-*.js 1> /dev/null 2>&1; then
        ...
        warning "⚠️ vendor-react não foi gerado"
    fi
...
if pm2 logs sispat --lines 5 --nostream 2>/dev/null | grep -q "baseUrl"; then
    warning "⚠️ Ainda há problemas de baseUrl nos logs"
else
    success "✅ Nenhum problema de baseUrl recente encontrado"
fi
...
# Instruções finais
log "📝 CORREÇÃO ERRO VITE CONFIG CONCLUÍDA!"
echo ""
echo "🎉 ERRO VITE CONFIG CORRIGIDO!"
echo "==============================="
echo ""
echo "📋 O que foi feito:"
echo "✅ PM2 parado"
echo "✅ Backup da configuração criado"
echo "✅ Configuração Vite corrigida criada"
echo "✅ Limpeza completa de cache e build"
echo "✅ Cache do npm limpo"
echo "✅ Build com configuração corrigida"
...
echo "   - Variáveis baseUrl e apiUrl definidas corretamente"
...
echo "   2. Verifique se não há mais erros de baseUrl"
...
success "🎉 Correção do erro vite.config.ts concluída!"
