...
# =============================================================================
# SCRIPT DE DIAGNÓSTICO - STATUS DO BACKEND
# Verifica o status do backend e identifica problemas
# =============================================================================
...
╔══════════════════════════════════════════════════════════════╗
║                                                              ║
║        🔍 DIAGNÓSTICO DE STATUS DO BACKEND                  ║
║                                                              ║
║              Verifica o status do backend e identifica      ║
...
show_summary() {
    ...
    echo -e "• ${YELLOW}Se houver URLs HTTPS: execute fix-urls-direct.sh${NC}"
}

# Função principal
main() {
    log_header "Iniciando diagnóstico de status do backend..."
