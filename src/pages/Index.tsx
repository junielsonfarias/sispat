  ...
  const features = [
    {
      ...
      description: 'Controle completo dos bens patrimoniais com rastreamento em tempo real',
      color: 'from-blue-500 to-blue-600'
    },
    {
      icon: Users,
      title: 'Gestão de Usuários',
      description: 'Controle de acesso e permissões para diferentes níveis de usuários',
      color: 'from-green-500 to-green-600'
    },
    {
      icon: FileText,
      title: 'Relatórios Avançados',
      description: 'Geração de relatórios detalhados e exportação em múltiplos formatos',
    ...
    },
    {
      icon: Settings,
      title: 'Configurações',
      description: 'Personalização completa do sistema conforme suas necessidades',
      color: 'from-gray-500 to-gray-600'
    },
    {
      icon: Shield,
      title: 'Segurança',
      description: 'Sistema seguro com autenticação e controle de acesso robusto',
        ...
        <div className='container mx-auto px-6 py-16'>
          <div className='text-center max-w-4xl mx-auto'>
            ...
            <p className='text-xl text-gray-600 mb-8 leading-relaxed'>
              Gerencie seu patrimônio de forma inteligente com nossa plataforma completa de gestão patrimonial. 
              Controle, monitore e otimize todos os seus bens em um só lugar.
            </p>
      ...
      <div className='container mx-auto px-6 py-16'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
            Descubra todas as funcionalidades que tornam o SISPAT a melhor escolha para gestão patrimonial
          </p>
        </div>
          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <div className='bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-8 border border-blue-200'>
              ...
              <p className='text-gray-600 mb-6'>
                Acesse o sistema e comece a gerenciar seu patrimônio de forma profissional
              </p>
              <Link
                to='/bens-cadastrados'
