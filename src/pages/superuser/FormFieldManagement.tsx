      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex gap-2'>
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Reverter Alterações?</AlertDialogTitle>
                <AlertDialogDescription>
                  Isso irá desfazer todas as alterações não salvas nos campos do
                  formulário. Esta ação não pode ser desfeita.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                <AlertDialogCancel>Cancelar</AlertDialogCancel>
                <AlertDialogAction onClick={rollbackFields}>
                  Confirmar
                </AlertDialogAction>
              </AlertDialogFooter>
            </AlertDialogContent>
