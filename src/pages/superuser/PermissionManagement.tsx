...
const allPermissions: { id: Permission; label: string; group: string }[] = [
  ...
  { id: 'imoveis:create', label: 'Criar Imóveis', group: 'Imóveis' },
  { id: 'imoveis:read', label: 'Visualizar Imóveis', group: 'Imóveis' },
  { id: 'imoveis:update', label: 'Editar Imóveis', group: 'Imóveis' },
  { id: 'imoveis:delete', label: 'Excluir Imóveis', group: 'Imóveis' },
  { id: 'emprestimos:read', label: 'Visualizar Empréstimos', group: 'Empréstimos' },
  { id: 'emprestimos:create', label: 'Registrar Empréstimos', group: 'Empréstimos' },
  { id: 'emprestimos:update', label: 'Registrar Devolução', group: 'Empréstimos' },
