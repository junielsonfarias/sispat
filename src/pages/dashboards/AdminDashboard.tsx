...
const AdminDashboard = () => {
  ...
  // Debug logs
  useEffect(() => {
    console.log('🏠 AdminDashboard - Patrimônios recebidos:', patrimonios.length)
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">Visão geral do patrimônio municipal</p>
        </div>
          ...
          {statsCards.map((card) => (
            ...
            >
              ...
              <CardContent className="p-4 text-center">
                <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-800">{card.value}</div>
              </CardContent>
            </Card>
          ))}
        </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-gray-50 hover:bg-gray-50">
                      <TableHead className="font-semibold text-gray-700">Patrimônio</TableHead>
                  ...
                  <TableBody>
                    {alertsData.map((alert, index) => (
                      <TableRow key={alert.id} className="hover:bg-gray-50 transition-colors duration-200">
                        <TableCell className="font-semibold text-gray-800">
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                            {alert.id}
                          </span>
                        </TableCell>
                        <TableCell className="text-gray-700">{alert.desc}</TableCell>
                        <TableCell>
                          <Badge
                            variant={
