...
import { PlusCircle, Trash2, Eye, Edit, Printer, AlertCircle, RefreshCw } from 'lucide-react'
...
export default function InventariosList() {
  const { inventories, isLoading, error, refetch, deleteInventory } = useInventory()
  const { user } = useAuth()
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            <div className="space-y-3" aria-label="Carregando inventários">
              {[1, 2, 3, 4].map((i) => (
