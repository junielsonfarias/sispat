...
export const AuditLogs: React.FC = () => {
  ...
  const filteredLogs = useMemo(() => {
    return logs.filter(log => {
      ...
      if (filters.resourceType && log.resource_type !== filters.resourceType)
        return false;
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value='data_management'>
                        Gestão de Dados
                      </SelectItem>
                      <SelectItem value='security'>Segurança</SelectItem>
                  ...
                  <CardContent className='p-6'>
                    <div className='flex items-center gap-2'>
                      ...
                      <div>
                        ...
                        <p className='text-2xl font-bold'>
                          {stats.summary.high_severity_events}
                        </p>
                      </div>
                    </div>
                  </CardContent>
        ...
        <TabsContent value='security' className='space-y-4'>
          <Alert>
            ...
            <AlertDescription>
              Esta seção mostra eventos de segurança e atividades suspeitas
          ...
          <Card>
            ...
            <CardContent>
              <p className='text-muted-foreground'>
                Implementação de monitoramento de eventos de segurança em
                desenvolvimento.
              </p>
            </CardContent>
          </Card>
