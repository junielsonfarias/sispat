      ...
      <div className='container mx-auto p-6'>
            ...
            <div className='flex items-center gap-4'>
              ...
              <div>
                ...
                <p className='text-gray-600 mt-1'>
                  Gerencie todos os patrimônios do sistema
                </p>
              </div>
            </div>
        ...
        <div className='grid grid-cols-4 gap-4 mb-6'>
          ...
          <div className='bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg shadow-sm border border-orange-200 p-4 hover:shadow-md transition-all duration-200'>
            <div className='flex items-center justify-between'>
              <div>
                <h3 className='text-xs font-medium text-orange-700 mb-1'>
                  Em Manutenção
                </h3>
        ...
        <div className='bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden'>
          <div className='bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200'>
            ...
            <p className='text-sm text-gray-600'>
              Gerencie todos os bens cadastrados no sistema
            </p>
          </div>
            ...
            <div className='w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6'>
              ...
              >
                <path
                  ...
                  strokeLinejoin='round'
                  strokeWidth={2}
                  d='M9.172 16.172a4 4 0 015.656 0M9 12h6m-6-4h6m2 5.291A7.962 7.962 0 0112 15c-2.34 0-4.47-.881-6.08-2.33M15 6.709A7.962 7.962 0 0112 4c-2.34 0-4.47.881-6.08 2.33'
                />
              </svg>
            </div>
