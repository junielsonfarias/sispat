            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div>
                <h3 className='text-lg font-semibold mb-4'>
                  {selectedImovel.numero_patrimonio}
                </h3>
                <div className='space-y-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm'>
                      {selectedImovel.municipality_name}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className='space-y-3'>
                  ...
                  <div className='grid grid-cols-2 gap-4'>
                    ...
                    {selectedImovel.area_construida && (
                      <div>
                        ...
                        <p className='text-sm'>
                          {selectedImovel.area_construida}m²
                        </p>
                      </div>
                    )}
                    {selectedImovel.valor_aquisicao && (
                      <div>
                        ...
                        <p className='text-sm'>
                          R${' '}
                          {selectedImovel.valor_aquisicao.toLocaleString(
                            'pt-BR'
                          )}
                        </p>
                      </div>
                  ...
                  {selectedImovel.latitude && selectedImovel.longitude && (
                    <div>
                      ...
                      <p className='text-sm'>
                        {selectedImovel.latitude.toFixed(6)},{' '}
                        {selectedImovel.longitude.toFixed(6)}
                      </p>
                    </div>
                  )}
                </div>
