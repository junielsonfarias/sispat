...
export const GlobalLogoManager = () => {
  ...
  const handleResetLogo = () => {
    const defaultLogo = 'https://img.usecurling.com/i?q=brazilian%20government&color=azure'
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configure a logo que será usada em todo o sistema: etiquetas, fichas, relatórios e demais documentos.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="text-sm text-muted-foreground">
          <p><strong>Dica:</strong> Use uma URL de imagem válida (PNG, JPG, SVG).</p>
