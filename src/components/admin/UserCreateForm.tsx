          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  O usuário terá acesso a todos os setores criados para este
                  município.
                </FormDescription>
                <FormMessage />
              </FormItem>
                  ...
                  <FormControl>
                    <MultiSelect
                      ...
                      placeholder={
                        sectorsLoading
                          ? 'Carregando setores...'
                          : 'Selecione os setores de acesso'
                      }
                      disabled={!municipalityId || sectorsLoading}
                    />
                  </FormControl>
                  <FormDescription>
                    O usuário terá acesso aos bens dos setores selecionados e
                    seus locais. Pode selecionar múltiplos setores.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
