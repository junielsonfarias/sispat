...
export const LoadingCard = ({ className, children }: LoadingCardProps) => (
  <div className={cn('rounded-lg border bg-card text-card-foreground shadow-sm p-6', className)}>
    <div className="flex flex-col items-center justify-center space-y-4">
      ...
      {children || <p className="text-sm text-muted-foreground">Carregando...</p>}
    </div>
  </div>
)
...
export const LoadingPage = ({ message = 'Carregando...', className }: LoadingPageProps) => (
...
export const LoadingOverlay = ({ loading, children, message = 'Carregando...' }: LoadingOverlayProps) => (
