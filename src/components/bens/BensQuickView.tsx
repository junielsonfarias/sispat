    ...
    <div className='p-4 space-y-6'>
      ...
      <div className='grid gap-6 md:grid-cols-2'>
        <div className='space-y-4'>
          ...
          />
          <DetailItem label='Cor' value={patrimonio.cor || 'N/A'} />
          <DetailItem label='Quantidade' value={patrimonio.quantidade || 1} />
          <DetailItem
            label='Status'
        ...
        <div className='space-y-4'>
          ...
          <DetailItem
            label='Localização'
            value={patrimonio.local_objeto || 'N/A'}
          />
          <DetailItem
