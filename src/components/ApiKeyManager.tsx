  ...
  const availablePermissions = [
    {
      value: 'read',
      label: 'Leitura',
      description: 'Acesso de leitura aos dados públicos',
    },
    {
      value: 'write',
      label: 'Escrita',
      description: 'Acesso de escrita (requer aprovação)',
    },
    {
      value: 'admin',
      label: 'Administrador',
    ...
    },
    {
      value: 'public',
      label: 'Público',
      description: 'Acesso apenas a dados públicos',
    },
  ];
  ...
  return (
    <div className='space-y-6'>
        ...
        <Dialog open={showNewKey} onOpenChange={setShowNewKey}>
          <DialogContent>
            ...
            <Alert>
              ...
              <AlertDescription>
                Guarde esta API key em um local seguro. Ela não será exibida
                novamente.
              </AlertDescription>
            </Alert>
            <div className='space-y-4'>
              ...
              <div className='flex justify-end'>
                <Button onClick={() => setShowNewKey(false)}>Fechar</Button>
              </div>
            </div>
          </DialogContent>
        </Dialog>
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Segurança:</strong> Mantenha suas API keys seguras e nunca as
          compartilhe. Use rate limiting apropriado e revogue keys que não estão
          mais sendo usadas.
        </AlertDescription>
      </Alert>
    </div>
