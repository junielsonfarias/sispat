  ...
  return (
    <Collapsible open={currentIsOpen} onOpenChange={handleOpenChange}>
      <CollapsibleTrigger asChild>
        <button
          className={cn(
            'w-full flex items-center justify-between px-3 py-2.5 text-sm font-semibold rounded-lg transition-all duration-200 hover:shadow-sm border border-l-4 mb-2 mt-4',
            groupColor,
