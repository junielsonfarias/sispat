...
export const TwoFactorSetup: React.FC<TwoFactorSetupProps> = ({
  ...
  const regenerateBackupCodes = async () => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/api/auth/2fa/regenerate-backup`,
        {
          method: 'POST',
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
            ...
            <div className='space-y-4'>
              ...
              {!status.enabled && (
                <Alert>
                  <Shield className='h-4 w-4' />
                  <AlertDescription>
                    Ative a autenticação de dois fatores para adicionar uma
                    camada extra de segurança à sua conta.
                  </AlertDescription>
                </Alert>
              )}
            </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div>
                    <p className='text-sm text-muted-foreground mb-4'>
                      Após configurar o aplicativo, clique em "Continuar" para
                      verificar
                    </p>
                    <Button
          ...
          {step === 'backup' && status.backupCodes && (
            <div className='space-y-6'>
              <div className='text-center'>
                ...
                <p className='text-muted-foreground'>
                  Salve estes códigos em um local seguro. Eles podem ser usados
              ...
              <Alert>
                <Shield className='h-4 w-4' />
                <AlertDescription>
                  <strong>Importante:</strong> Estes códigos só serão mostrados
                  uma vez. Salve-os imediatamente em um local seguro.
                </AlertDescription>
              </Alert>
