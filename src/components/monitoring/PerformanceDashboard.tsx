  ...
  useEffect(() => {
    if (data) {
      const newDataPoint = {
        ...
        memory: Math.round(
          (data.system.memoryUsage / data.system.memoryTotal) * 100
        ),
        ...
        <>
          ...
          <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
            <MetricCard
              ...
              status={getStatusFromValue(data.system.cpuUsage, {
                warning: 75,
                critical: 90,
              })}
            />
            ...
            <MetricCard
              ...
              status={getStatusFromValue(data.api.averageResponseTime, {
                warning: 500,
                critical: 1000,
              })}
            />
            ...
            <MetricCard
              ...
              status={getStatusFromValue(data.api.errorRate * 100, {
                warning: 5,
                critical: 10,
              })}
            />
            ...
            <Card>
              ...
              <CardContent className='space-y-2'>
                ...
                <div className='flex justify-between'>
                  ...
                  <span
                    className={`font-medium ${data.api.errorRate > 0.05 ? 'text-red-600' : 'text-green-600'}`}
                  >
                ...
                <div className='flex justify-between'>
                  ...
                  <span className='font-medium'>
                    {data.api.requestsPerSecond.toFixed(2)}
                  </span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className='space-y-2'>
                ...
                <div className='flex justify-between'>
                  ...
                  <span
                    className={`font-medium ${data.database.slowQueries > 0 ? 'text-red-600' : 'text-green-600'}`}
                  >
                ...
                <div className='flex justify-between'>
                  ...
                  <span className='font-medium'>
                    {Math.round(data.database.averageQueryTime)}ms
                  </span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className='space-y-2'>
                ...
                <div className='flex justify-between'>
                  ...
                  <span className='font-medium'>
                    {formatBytes(
                      data.system.memoryTotal - data.system.memoryUsage
                    )}
                  </span>
                </div>
                <div className='flex justify-between'>
        ...
        <Card>
          <CardContent className='flex flex-col items-center justify-center h-64 space-y-4'>
            ...
            <div className='text-center'>
              ...
              <p className='text-muted-foreground'>
                Conecte-se ao sistema de monitoramento para visualizar as
                métricas
              </p>
            </div>
