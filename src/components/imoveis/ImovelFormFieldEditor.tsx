...
interface ImovelFormFieldEditorProps {
  field?: ImovelFieldConfig
  onSave: (data: Omit<ImovelFieldConfig, 'id'>) => void
  onClose: () => void
}

export const ImovelFormFieldEditor = ({
  field,
  onSave,
  onClose,
}: ImovelFormFieldEditorProps) => {
        ...
        <FormField
          ...
          render={({ field: formField }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Ex: Matrícula do Imóvel" {...formField} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field: formField }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="Ex: matricula_imovel"
                  {...formField}
