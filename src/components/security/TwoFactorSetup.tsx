        ...
        <CardContent className='space-y-6'>
          ...
          <div className='text-center space-y-4'>
            ...
            <p className='text-sm text-muted-foreground'>
              Use um aplicativo como Google Authenticator, Authy ou Microsoft
              Authenticator
            </p>
          </div>
          ...
          {!showBackupCodes && (
            <Alert>
              ...
              <AlertDescription>
                Após ativar o 2FA, você receberá códigos de backup para usar
                caso perca acesso ao seu dispositivo.
              </AlertDescription>
            </Alert>
          )}
          ...
          {showBackupCodes && setupData.backupCodes && (
            <div className='space-y-2'>
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Códigos de Backup:</strong> Guarde estes códigos em
                  local seguro. Cada um pode ser usado apenas uma vez caso você
                  perca acesso ao seu dispositivo.
                </AlertDescription>
              </Alert>
      ...
      <Dialog open={showBackupDialog} onOpenChange={setShowBackupDialog}>
        <DialogContent className='max-w-md'>
          <DialogHeader>
            ...
            <DialogDescription>
              Guarde estes novos códigos em local seguro. Os códigos anteriores
              foram invalidados.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={() => setShowBackupDialog(false)}>Concluir</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
