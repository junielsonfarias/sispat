...
import { calculatePasswordStrength, DEFAULT_PASSWORD_POLICY, generateSecurePassword } from '@/services/passwordPolicy'
    ...
    <Card className={className}>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="text-xs text-muted-foreground space-y-1">
          <p><strong>Dica:</strong> Use um gerenciador de senhas para armazenar com segurança</p>
          <p><strong>Recomendação:</strong> Ative a autenticação de dois fatores sempre que possível</p>
        </div>
      </CardContent>
    </Card>
  )
